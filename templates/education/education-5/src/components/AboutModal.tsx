        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1 text-slate-700 text-xs sm:text-sm">
          <div>
            ...
            <p className="leading-relaxed text-slate-600">
              Learnora was founded on a simple principle: high-impact education should bridge the gap between academic theory and production-grade industry demands. We combine hands-on coding sandboxes, expert mentorship, and structured career paths so anyone can build their future with confidence.
            </p>
          </div>
