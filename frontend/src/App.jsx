...
import SageWeddingTemplate from './pages/SageWeddingTemplate';
...
function AppRoutes({ user, cart, addToCart, removeFromCart, clearCart, handleLogin, handleLogout }) {
  ...
  const isTemplateRoute = 
    ...
    location.pathname.startsWith('/templates/photography/sage-wedding');
  ...
  if (isTemplateRoute) {
    return (
      <Routes>
        ...
        <Route path="/templates/photography/sage-wedding" element={<DevicePreviewWrapper><SageWeddingTemplate /></DevicePreviewWrapper>} />
        <Route path="/templates/photography/sage-wedding/index.html" element={<DevicePreviewWrapper><SageWeddingTemplate /></DevicePreviewWrapper>} />
      </Routes>
    );
  }
