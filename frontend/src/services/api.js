...
const MOCK_TEMPLATES = [
  ...
  },
  {
    ...
    slug: 'travelverse',
    previewImage: '/travels-1-cover.jpg',
    templateType: 'FREE',
    price: 0,
  ...
  },
  {
    ...
    previewImage: '/travels-2-cover.jpg',
    templateType: 'FREE',
    price: 0,
    category: { id: 5, name: 'Travels', slug: 'travels' },
    pagesCount: 1,
  ...
  },
  {
    ...
    previewImage: '/travels-3-cover.jpg',
    templateType: 'FREE',
    price: 0,
    category: { id: 5, name: 'Travels', slug: 'travels' },
    pagesCount: 1,
  ...
  {
    id: 146,
    name: 'Wanderlust Tales — Premium Travel & Adventure Blog',
    slug: 'wanderlust-tales-blog',
    previewImage: '/travels-4-cover.jpg',
    templateType: 'FREE',
    price: 0,
    category: { id: 5, name: 'Travels', slug: 'travels' },
    pagesCount: 1,
    downloadsCount: 840,
    description: 'A warm, editorial travel and adventure blog built using React and styled with Tailwind CSS. Features interactive world map location logs, ghost outline parallax hero headers, video-style blog entries, and custom Accordions.',
    bootstrapVersion: 'React / Tailwind CSS / Motion',
    version: '1.0.0',
  ...
  },
  {
    ...
    previewImage: '/travels-5-cover.jpg',
    templateType: 'FREE',
    price: 0,
    category: { id: 5, name: 'Travels', slug: 'travels' },
    pagesCount: 1,
  ...
  {
    id: 148,
    name: 'Exploria — Bold & Vibrant Travel Company Website',
    slug: 'exploria-travel-company',
    previewImage: '/travels-6-cover.jpg',
    templateType: 'FREE',
    price: 0,
    category: { id: 5, name: 'Travels', slug: 'travels' },
    pagesCount: 1,
    downloadsCount: 2200,
    description: 'A bold, vibrant travel company template built using React and styled with Tailwind CSS. Features massive contrasting headlines, staggered landmark photo collages, floating airplane animations, and interactive counters.',
    bootstrapVersion: 'React / Tailwind CSS / Motion',
    version: '1.0.0',
    demoUrl: '/templates/travels/travels-6/index.html'
  },
  {
    id: 20,
