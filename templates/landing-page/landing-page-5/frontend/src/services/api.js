...
const MOCK_TEMPLATES = [
  {
    id: 110,
    name: 'Gravitas — Spatial Agency Landing Page',
    slug: 'gravitas',
    description: 'A futuristic, dark glassmorphism agency landing page for a digital design & spatial technology studio. Features floating glow orbs, animated orbital navbar badge, hero with staggered fade-up, 6-card services grid, filterable portfolio showcase, 3-col testimonials, CTA banner, and a neon-border contact form — all powered by pure CSS keyframe animations.',
    price: 49.00,
    templateType: 'PREMIUM',
    previewImage: 'https://images.unsplash.com/photo-1634017839464-5c339ebe3cb4?auto=format&fit=crop&w=600&q=80',
    demoUrl: '/gravitas',
    bootstrapVersion: 'React / CSS3 (Pure CSS Animations)',
    pagesCount: 1,
    downloadsCount: 5120,
    version: '1.0.0',
  ...
  {
    id: 109,
    name: 'Aetheris Cloud Platform',
    slug: 'aetheris',
    description: 'An elite, high-converting React landing page template built for high-performance cloud networks. Employs a weightless design system, interactive latency trackers, live dynamic counters, a tabbed Edge API architecture showcase, and fluid billing matrices.',
    price: 39.00,
    templateType: 'PREMIUM',
    previewImage: 'https://images.unsplash.com/photo-1639762681485-074b7f938ba0?auto=format&fit=crop&w=600&q=80',
    demoUrl: '/aetheris',
    bootstrapVersion: 'React / CSS3',
    pagesCount: 1,
    downloadsCount: 3890,
    version: '1.0.0',
