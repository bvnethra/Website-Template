...
import MusicEducationTemplate from './pages/MusicEducationTemplate';
...
function AppRoutes({ user, cart, addToCart, removeFromCart, clearCart, handleLogin, handleLogout }) {
  ...
  const isTemplateRoute = 
    ...
    location.pathname.startsWith('/templates/education/education-11')
  ...
  if (isTemplateRoute) {
    return (
      <Routes>
        ...
        {/* Education templates */}
        <Route path="/templates/education/education-11/*" element={<DevicePreviewWrapper><MusicEducationTemplate /></DevicePreviewWrapper>} />
      </Routes>
    );
  }
