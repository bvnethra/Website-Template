      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10 text-center">
        ...
        >
          ...
          <div className="space-y-1 select-none">
            ...
            <h2 className="font-display text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold uppercase text-[#0066FF] tracking-tight leading-[0.95]">
              LET'S BUILD IT.
            </h2>
          </div>
          ...
          <p className="text-base sm:text-xl text-[#888888] font-normal max-w-xl mx-auto leading-relaxed">
            Tell us what you're trying to achieve. We'll help define the right approach, assemble the dedicated team, and execute with precision.
          </p>
