...
export const ExamResults: React.FC = () => {
  ...
  const handleDownloadTranscript = () => {
    const textData = `LEARNORA UNIVERSITY OF TECHNOLOGY
...
Controller of Examinations, Learnora University.`;

    const blob = new Blob([textData], { type: 'text/plain' });
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a');
    a.href = url;
    a.download = `Learnora_Marksheet_Sem${selectedSemester}_${currentUser?.studentId}.txt`;
    a.click();
      ...
      >
            ...
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <span className="text-[10px] font-mono font-bold uppercase tracking-widest text-[#FF6B4A]">
                  Learnora University • Office of the Registrar
                </span>
        ...
        <div className="pt-4 border-t border-[#E5DFD5] flex flex-col sm:flex-row items-center justify-between text-xs text-[#476666] gap-4">
          <div className="flex items-center gap-2">
            ...
            <span>Digital Cryptographic Signature Verified by Learnora Registry.</span>
          </div>
