...
import BlushWeddingTemplate from './pages/BlushWeddingTemplate';
...
function AppRoutes({ user, cart, addToCart, removeFromCart, clearCart, handleLogin, handleLogout }) {
  ...
  const isTemplateRoute = 
    ...
    location.pathname.startsWith('/templates/photography/blush-wedding');
  ...
  if (isTemplateRoute) {
    return (
      <Routes>
        ...
        <Route path="/templates/photography/blush-wedding" element={<DevicePreviewWrapper><BlushWeddingTemplate /></DevicePreviewWrapper>} />
        <Route path="/templates/photography/blush-wedding/index.html" element={<DevicePreviewWrapper><BlushWeddingTemplate /></DevicePreviewWrapper>} />
