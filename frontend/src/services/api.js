...
const MOCK_TEMPLATES = [
  {
    ...
    slug: 'creative-multipage-portfolio',
    previewImage: '/creative-multipage-portfolio_cover.png',
    templateType: 'FREE',
    price: 0,
    category: { id: 18, name: 'portfolio', slug: 'portfolio' },
    pagesCount: 8,
    downloadsCount: 620,
    description: 'A professional, dynamic multi-page personal portfolio website for creative professionals. Features a full-screen photographic hero, elegant serif branding, white navbar background with a magenta/pink active accent, and true page-wise routing using React Router DOM.',
    bootstrapVersion: 'React / React Router / Tailwind CSS / Motion',
    version: '1.0.0',
    demoUrl: '/templates/portfolio/creative-multipage-portfolio/index.html'
  },
  {
    id: 158,
    name: 'Sasha Grey — Monochrome Editorial Photography',
    slug: 'photography-portfolio',
    previewImage: '/photography-portfolio_cover.png',
    templateType: 'FREE',
    price: 0,
    category: { id: 18, name: 'portfolio', slug: 'portfolio' },
    pagesCount: 8,
    downloadsCount: 540,
    description: 'A minimal, high-contrast black-and-white editorial photography portfolio website utilizing React Router DOM for page routing. Features a full-screen hero backdrop, ghost-text watermarks, filterable grid portfolios, and timelines.',
    bootstrapVersion: 'React / React Router / Tailwind CSS / Motion',
    version: '1.0.0',
    demoUrl: '/templates/portfolio/photography-portfolio/index.html'
  },
  {
    id: 157,
    name: 'Evelyn Oswald — Editorial Operations Portfolio',
    slug: 'editorial-portfolio',
    previewImage: '/editorial-portfolio_cover.png',
    templateType: 'FREE',
    price: 0,
    category: { id: 18, name: 'portfolio', slug: 'portfolio' },
    pagesCount: 1,
    downloadsCount: 310,
    description: 'An elegant, editorial black-and-white single-page site for professional service providers. Designed with a script accent brand wordmark, pricing grids, executive timeline trees, and counter counters.',
    bootstrapVersion: 'React / Tailwind CSS / Motion / ScrollSpy',
    version: '1.0.0',
    demoUrl: '/templates/portfolio/editorial-portfolio/index.html'
  },
  {
    id: 156,
    name: 'Jared Vance — Warm Gradient Portfolio',
    slug: 'gradient-portfolio',
    previewImage: '/gradient-portfolio_cover.png',
    templateType: 'FREE',
    price: 0,
    category: { id: 18, name: 'portfolio', slug: 'portfolio' },
    pagesCount: 1,
    downloadsCount: 380,
    description: 'A bold, warm-toned single-page portfolio with a vivid orange-to-deep-red gradient hero, dramatic silhouette portraits, overlapping trusted logo strips, and hover reveal grids.',
    bootstrapVersion: 'React / Tailwind CSS / Motion / ScrollSpy',
    version: '1.0.0',
    demoUrl: '/templates/portfolio/gradient-portfolio/index.html'
  },
  {
    id: 155,
    name: 'Synthetix — Tech-Forward Software Agency',
    slug: 'agency-portfolio',
    previewImage: '/agency-portfolio_cover.png',
    templateType: 'FREE',
    price: 0,
    category: { id: 18, name: 'portfolio', slug: 'portfolio' },
    pagesCount: 5,
    downloadsCount: 460,
    description: 'A professional, dynamic multi-page software agency template with a tech-forward dark theme, green radial glow details, count-up statistic widgets, animated wireframes, and blog detail overlays.',
    bootstrapVersion: 'React / React Router / Tailwind CSS / Motion',
    version: '1.0.0',
    demoUrl: '/templates/portfolio/agency-portfolio/index.html'
  },
  {
    id: 154,
    name: 'Evelyn Vance — Routed Multipage Portfolio',
    slug: 'multipage-portfolio',
    previewImage: '/multipage-portfolio_cover.png',
    templateType: 'FREE',
    price: 0,
    category: { id: 18, name: 'portfolio', slug: 'portfolio' },
    pagesCount: 8,
    downloadsCount: 520,
    description: 'A dark-themed multipage personal portfolio template with complete page-wise routing using React Router DOM. Designed with coral-red highlights, animated resume timelines, pricing grids, and custom scroll anchors.',
    bootstrapVersion: 'React / React Router / Tailwind CSS / Motion',
    version: '1.0.0',
    demoUrl: '/templates/portfolio/multipage-portfolio/index.html'
  },
  {
    id: 153,
    name: 'Clara Oswald — Airy Minimalist Portfolio',
    slug: 'minimal-portfolio',
    previewImage: '/minimal-portfolio_cover.png',
    templateType: 'FREE',
    price: 0,
    category: { id: 18, name: 'portfolio', slug: 'portfolio' },
    pagesCount: 1,
    downloadsCount: 290,
    description: 'A clean, minimal, and airy light-themed personal portfolio template with generous whitespace, playfair serif typography, soft outlines, and subtle details.',
    bootstrapVersion: 'React / Tailwind CSS / Motion / Lucide',
    version: '1.0.0',
    demoUrl: '/templates/portfolio/minimal-portfolio/index.html'
  },
  {
    id: 152,
    name: 'Sasha Grey — Bold High-Contrast Creative Portfolio',
    slug: 'creative-portfolio',
    previewImage: '/creative-portfolio_cover.png',
    templateType: 'FREE',
    price: 0,
    category: { id: 18, name: 'portfolio', slug: 'portfolio' },
    pagesCount: 1,
    downloadsCount: 410,
    description: 'A bold, high-contrast creative portfolio featuring geometric shape overlays, outline masks, animated skill meters, testimonials sliders, and structural project lightboxes.',
    bootstrapVersion: 'React / Tailwind CSS / Motion / Lucide',
    version: '1.0.0',
    demoUrl: '/templates/portfolio/creative-portfolio/index.html'
  },
  {
    id: 151,
    name: 'Aiden Drake — Modern Dark Personal Portfolio',
    slug: 'personal-portfolio',
    previewImage: '/personal-portfolio_cover.png',
    templateType: 'FREE',
    price: 0,
    category: { id: 18, name: 'portfolio', slug: 'portfolio' },
    pagesCount: 1,
    downloadsCount: 320,
    description: 'A modern, dark-themed personal portfolio website for product designers and developers. Crafted with scroll-spy navigation, glowing components, a grouped skills metrics grid, and detailed project showcase modals.',
    bootstrapVersion: 'React / Tailwind CSS / Motion / Lucide',
    version: '1.0.0',
    demoUrl: '/templates/portfolio/personal-portfolio/index.html'
  },
  {
    id: 150,
    name: 'Aethelgard — Minimalist Architecture Portfolio',
    slug: 'architecture-portfolio',
    previewImage: '/architecture-portfolio_cover.png',
    templateType: 'FREE',
    price: 0,
    category: { id: 18, name: 'portfolio', slug: 'portfolio' },
    pagesCount: 1,
    downloadsCount: 180,
    description: 'A minimal, elegant, and editorial architecture portfolio website inspired by high-end design magazines. Designed with clean grids, generous white space, smooth framer-motion transitions, and dynamic details.',
    bootstrapVersion: 'React / Tailwind CSS / Motion',
    version: '1.0.0',
    demoUrl: '/templates/portfolio/architecture-portfolio/index.html'
  },
  {
    id: 126,
