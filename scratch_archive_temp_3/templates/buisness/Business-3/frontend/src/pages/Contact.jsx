    ...
    <AnimatedPage>
      <div className="pt-24 pb-20 overflow-hidden">
        ...
        <section className="relative max-w-7xl mx-auto px-6 py-12 text-center flex flex-col items-center gap-6">
          <div className="absolute top-[-30%] left-[20%] w-96 h-96 bg-[#7C3AED]/10 rounded-full blur-[100px] -z-10" />
        ...
        <section className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            <div className="bg-lightAccent border border-customBorder rounded-3xl p-6.5 shadow-sm flex items-start gap-4">
              <div className="w-10 h-10 rounded-xl bg-[#1E1033] text-primaryAccent flex items-center justify-center shrink-0 border border-customBorder">
                <MapPin size={20} />
              </div>
              <div>
          ...
          {/* Form (Right) */}
          <div className="lg:col-span-8 bg-lightAccent border border-customBorder rounded-3xl p-8 md:p-10 shadow-sm">
            <AnimatePresence mode="wait">
              {submitStatus === 'success' ? (
                ...
                >
                  <div className="w-16 h-16 rounded-full bg-emerald-950/20 text-emerald-400 border border-emerald-900/50 flex items-center justify-center mb-2">
                    <CheckCircle size={32} />
                  </div>
                  ...
                  <button 
                    ...
                    className="mt-4 border border-customBorder text-primaryText px-6 py-2.5 rounded-full text-xs font-bold hover:bg-[#1E1033] transition-all cursor-pointer"
                  >
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  {submitStatus === 'error' && (
                    <div className="bg-rose-950/20 border border-rose-900/50 text-rose-300 px-4 py-3.5 rounded-xl text-xs flex items-center gap-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="flex flex-col gap-1.5">
                      ...
                      <input 
                        ...
                        className={`w-full bg-[#1E1033] border rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-primaryAccent focus:bg-[#2E1A47] text-primaryText transition-colors placeholder-secondaryText/40 ${
                          errors.name ? 'border-rose-500/50 focus:border-rose-400' : 'border-customBorder'
                        }`}
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <input 
                        ...
                        onChange={handleChange}
                        className={`w-full bg-[#1E1033] border rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-primaryAccent focus:bg-[#2E1A47] text-primaryText transition-colors placeholder-secondaryText/40 ${
                          errors.email ? 'border-rose-500/50 focus:border-rose-400' : 'border-customBorder'
                        }`}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="flex flex-col gap-1.5">
                      ...
                      <input 
                        ...
                        onChange={handleChange}
                        className="w-full bg-[#1E1033] border border-customBorder rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-primaryAccent focus:bg-[#2E1A47] text-primaryText transition-colors placeholder-secondaryText/40"
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input 
                      ...
                      onChange={handleChange}
                      className={`w-full bg-[#1E1033] border rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-primaryAccent focus:bg-[#2E1A47] text-primaryText transition-colors placeholder-secondaryText/40 ${
                        errors.subject ? 'border-rose-500/50 focus:border-rose-400' : 'border-customBorder'
                      }`}
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <textarea 
                      ...
                      onChange={handleChange}
                      className={`w-full bg-[#1E1033] border rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-primaryAccent focus:bg-[#2E1A47] text-primaryText transition-colors resize-none placeholder-secondaryText/40 ${
                        errors.message ? 'border-rose-500/50 focus:border-rose-400' : 'border-customBorder'
                      }`}
