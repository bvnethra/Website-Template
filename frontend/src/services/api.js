...
const MOCK_TEMPLATES = [
  ...
  {
    id: 154,
    name: 'Noah Everwood — Wildlife Photographer Portfolio',
    slug: 'portfolio-5',
    previewImage: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=800&q=80',
    templateType: 'FREE',
    price: 0,
    ...
    pagesCount: 1,
    downloadsCount: 1650,
    description: 'A cinematic documentary-style portfolio for photographers and storytellers. Features horizontal gallery sliders, expedition maps, ambient nature audio, and structured narrative profiles.',
    bootstrapVersion: 'React / Vite / CSS',
    version: '1.0.0',
