...
export default function PhotographyCatalog() {
  ...
  const handleDownload = async () => {
    ...
    const files = [
      { name: 'index.html', url: '/templates/photography/snapfolio-template/index.html' },
      { name: 'style.css', url: '/templates/photography/snapfolio-template/style.css' },
      { name: 'script.js', url: '/templates/photography/snapfolio-template/script.js' }
    ];
    ...
    try {
      ...
      link.download = 'snapfolio-template.zip';
      document.body.appendChild(link);
      link.click();
      document.body.removeChild(link);
      
      showToast('Template zip downloaded successfully!');
    } catch (err) {
      console.error(err);
      showToast('Failed to bundle template files.', 'error');
    } finally {
      ...
      <div style={{
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <a 
              href="/templates/photography/snapfolio-template/index.html" 
              target="_blank" 
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              <h3 style={{
                ...
                >
                  SnapFolio — Dark Minimalist Portfolio
                </a>
              </h3>
              <p style={{
                fontSize: '0.85rem',
                ...
                A dark-themed photography portfolio featuring a floating glass sidebar navigation, animated typewriter hero headlines, responsive masonry layouts, next/prev arrow keyboard navigation lightbox, and integrated booking validation feedback.
              </p>
            </div>
          ...
          <div style={{
            ...
            <button 
              ...
              onMouseEnter={(e) => { if(!downloading) e.currentTarget.style.backgroundColor = '#433cc8'; }}
              onMouseLeave={(e) => { if(!downloading) e.currentTarget.style.backgroundColor = '#544ee8'; }}
            >
              {downloading ? (
