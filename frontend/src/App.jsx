...
// Mock components to prevent compilation errors if they don't exist yet
const Templates = () => <div style={{ padding: 40 }}><h2>Templates Listing</h2></div>;
const TemplateDetails = () => <div style={{ padding: 40 }}><h2>Template Details</h2></div>;
const Dashboard = () => <div style={{ padding: 40 }}><h2>User Dashboard</h2></div>;
const Builder = () => <div style={{ padding: 40 }}><h2>Template Builder</h2></div>;
...
function AppRoutes({ user, cart, addToCart, removeFromCart, clearCart, handleLogin, handleLogout }) {
  ...
  const isEducationRoute =
    ...
    location.pathname === '/myschool' ||
    location.pathname === '/education-1' ||
    location.pathname === '/templates/education';
