...
export const initialStudentProfile: StudentProfileData = {
  ...
  email: 'aarav.sharma@student.learnora.edu',
...
export const initialHallTicket: HallTicketData = {
  ...
  examCenter: 'Learnora Main Campus - Sir C.V. Raman Examination Block (Block C)',
  ...
  instructions: [
    ...
    'Strictly produce this original Hall Ticket along with valid Learnora University Student ID card.',
  ...
  },
  {
    ...
    responses: [
      ...
      },
      {
        ...
        message: 'The SGPA is truncated at two decimal points according to Learnora University 2023 Academic Regulations.',
